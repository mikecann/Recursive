...
var HeroController = (function () {
    function HeroController(heroId) {
        ...
        this.view = $("#" + heroId);
        this.view.click(function () { return _this.tree = _this.getBranch(0); });
    ...
    HeroController.prototype.renderTree = function () {
        ...
        var renderBranch = function (b) {
            ...
            ctx.lineTo(0, 0);
            ctx.stroke();
            b.branches.forEach(function (bb) { return renderBranch(bb); });
            ctx.restore();
        };
        renderBranch(this.tree);
        ctx.restore();
        requestAnimationFrame(function () { return _this.renderTree(); });
    };
