var Signal0 = (function () {
    ...
    Signal0.prototype.dispatch = function () {
        ...
        this.onceHandlers.forEach(function (h) { return h(); });
        this.onceHandlers = [];
    };
    return Signal0;
})();
var Signal1 = (function () {
    ...
    Signal1.prototype.dispatch = function (param1) {
        this.handlers.forEach(function (h) { return h(param1); });
        this.onceHandlers.forEach(function (h) { return h(param1); });
        this.onceHandlers = [];
    };
    return Signal1;
})();
var Signal2 = (function () {
    ...
    Signal2.prototype.dispatch = function (param1, param2) {
        this.handlers.forEach(function (h) { return h(param1, param2); });
        this.onceHandlers.forEach(function (h) { return h(param1, param2); });
        this.onceHandlers = [];
    };
    return Signal2;
})();
